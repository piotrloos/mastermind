...
def main():
    ...
    ms = MastermindSolver(colors=7, pegs=8, shuffle_before=True, shuffle_after=False, solve_mode=2)
    ...
    print(
        ...
        .format(
            shuffle_before=ms.shuffle_before,
            shuffle_after=ms.shuffle_after,
            solve_mode=ms.solve_mode,
        )
    )
    print()
