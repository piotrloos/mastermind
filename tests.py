...
class PegsCalculateTests(unittest.TestCase):
    ...
    def test_example_game(self):
        ...
        self.assertTupleEqual(self.a.take_turn((1, 6, 9, 7, 10, 4)), (0, 0))
        self.assertTupleEqual(self.a.take_turn((1, 6, 5, 6, 8, 4)), (0, 2))
        self.assertTupleEqual(self.a.take_turn((9, 2, 3, 7, 2, 10)), (0, 2))
        self.assertTupleEqual(self.a.take_turn((8, 8, 10, 5, 10, 3)), (2, 2))
        self.assertTupleEqual(self.a.take_turn((3, 8, 10, 10, 1, 5)), (1, 2))
        self.assertTupleEqual(self.a.take_turn((5, 4, 10, 8, 3, 8)), (0, 4))
        self.assertTupleEqual(self.a.take_turn((10, 5, 8, 9, 5, 8)), (2, 1))
        self.assertTupleEqual(self.a.take_turn((7, 7, 8, 3, 8, 5)), (2, 2))
        self.assertTupleEqual(self.a.take_turn((2, 8, 6, 3, 5, 3)), (5, 0))
        self.assertTupleEqual(self.a.take_turn((8, 3, 2, 5, 3, 8)), (0, 6))
        self.assertEqual(self.a.game_status, 0)
        self.assertTupleEqual(self.a.take_turn((2, 8, 8, 3, 5, 3)), (6, 0))
